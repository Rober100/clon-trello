...
type Props =
  | DropdownMenuBoardOptionsProps
  | DropdownMenuListAndTaskOptionsProps;
...
const DropdownMenuOptions = (props: Props) => {
  ...
  return (
    <>
      ...
      <DialogBoardTitle
        open={titleMenuOpen}
        setOpen={setTitleMenuOpen}
        setTitle={props.setTitle}
      />
      <DialogBoardDelete
        open={removeMenuOpen}
        setOpen={setRemoveMenuOpen}
        setDelete={props.setRemove}
      />
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          <DropdownMenuItem
            onClick={() => setRemoveMenuOpen(true)}
            className="cursor-pointer"
          >
